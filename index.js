...
async function parseUserModuleData(pool, message) {
  try {
...
async function parseRealEstateModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
...
async function parseAccountabilityModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
...
async function parsePaymentsModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
...
async function parseLegalsModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
...
async function parseLogisticsModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
...
async function parseTicketsModuleData(pool, message) {
  try {
    const tableName = "raw_"+message.module_id;
    const data = message.data;
    // Validar que el nombre de la tabla no contenga caracteres peligrosos
